...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-32 overflow-hidden rounded-[--radius] border border-border bg-background p-1 text-foreground shadow-lg',
      className
    )}
    {...props}
  />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-48 overflow-hidden rounded-[--radius] border border-border bg-background p-1 text-foreground shadow-md',
        className
      )}
      {...props}
    />
